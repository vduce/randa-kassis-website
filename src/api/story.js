...
const story = [
  ...
  },
  {
    ...
    des2: `<div class="responsive-text">
    ...
    des3: `I have no right to weep for you, for I was never by your side. I have no right to speak of pain, for I was always far from you. <br><br>
...
The Russia-hosted Syrian National Dialogue Congress in Sochi may pave the way to the resolution of the Syrian crisis, Randa Kassis, the leader of the "Astana platform" of the Syrian opposition, has told Sputnik, highlighting the necessity of the creation of the constitutional commission during the ongoing summit to facilitate the peace process.`,
    des1: `Those who have come to the Syrian National Dialogue Congress in the Russian resort city of Sochi are motivated by patriotism and responsibility for the future of their country, Randa Kassis, the leader of the "Astana platform" of the Syrian opposition, told Sputnik Arabic, slamming those who snubbed the summit.`,
    des2: `"Anyone who refused to participate in the Sochi congress is irresponsible," the politician highlighted.`,
    des3: `According to Kassis, all the members of her delegation understand that the Syrian crisis could not be resolved under the aegis of the United States. The Syrians have to kick-start the process themselves, here, in Sochi, she stressed.`,
    des4: `"We must continue to work despite numerous difficulties faced by the Syrian opposition," the politician said. "We must do everything to ensure the success of the Sochi talks."`,
    des5: `Kassis underscored that President Vladimir Putin's initiative to hold the Syrian National Dialogue Congress in Sochi is an important step, which, unfortunately, was not accepted by some political figures.`,
    des6: `"If Vladimir Putin initiated something, it means not just the intention to do something, but the implementation of the objectives," she pointed out. "Therefore, I pin my hopes on the event and this is why we arrived in Sochi."`,
    des7: `The politician emphasised that she had made efforts to gather as many representatives of the Syrian opposition as possible to form a working group. "We need to start finding the way out of the crisis immediately. I believe that it is impossible without the creation of a new constitution," she noted.`,
    des8: `Speaking to Sputnik, Kassis shed light on the Astana platform's plans and program. The politician emphasised the necessity to create a "constitutional commission" within the framework of the negotiations.`,
    des9: `"We need to start working on a new Syrian constitution," she said. "We have prepared our own draft constitution, on which we have spent a year working on."`,
    des10: `According to the politician one of the most important issues concerning the future Syrian constitution is the maintenance of a secular state: "To clarify this issue I offered the following [definition]: the secularism is defined by the state's neutrality to religious or non-religious beliefs of a Syrian citizen," she said, "Beliefs could be not only religious, it could be views or a position and a person should have freedom [to express them]."`,
    des11: `The present Syrian constitution offers four options to define a Syrian citizen's religious beliefs: Sunni Muslim, Druze, Orthodox or Catholic Christian. Kassis explained that for ordinary Syrians the matters of marriages and inheritance are closely connected with their religious beliefs and existing state laws.`,
    des12: `She noted that "in order to overcome the potential difficulties" she proposes "to introduce the fifth category — "a Syrian citizen" — without any religious references."`,
    des13: `"It is necessary to give the Syrians the freedom of choice. A person may prefer to live in an exclusively secular legal field," Kassis suggested.`,
    des14: `On January 30 the Syrian national dialogue congress officially opened in Sochi. The summit has brought together various opposition and pro-governmental forces, as well as representatives of the country's numerous ethnic and religious groups in order to facilitate the peace process with the focus on the Syrian constitution and elections.`,
    des15: `The UN Security Council permanent members as well as Egypt, Iraq, Jordan, Kazakhstan, Lebanon and Saudi Arabia were also invited to participate in the event as observers. However, a number of states including the US and France, refused to attend, as did the Syrian Negotiation Commission (SNC) opposition group.`,
    des16: ``,
...
They also discussed the need to support the constructive and balanced approach of the new UN Special Envoy Geir Pedersen.`,
  ...
  },
  {
    ...
    author: "john doe",
    date: "02/05/2024",
    storyTitle: `Kassis meets Beibut Atamkulov, Minister of Foreign Affairs of Kazakhstan
26-02-2019
...
Kazakhstan's contribution to peace has been paramount.`,
  ...
  },
  {
    ...
    author: "john doe",
    date: "02/05/2024",
    storyTitle: `The Syrian opposition on Monday presented a "road map" to peace, including steps to be taken ahead of an election and guidelines for a plan to write the country's post-war constitution. The document, drawn up by representatives of the opposition invited to Rome by the Catholic Sant'Egidio community, will be presented to key players in the conflict — from Russia to Turkey and the EU — over the next few weeks.`,
    des1: "Lacus, etiam sed est eu tempus need Temer diam congue laoret .",
    des2: "One way to categorize the activities is in terms of the professional's area of expertise such as competitive analysis, corporate strategy the activities",
    icon: "flaticon-bus",
    ssImg1: sImgS4,
    ssImg2: sImgS4,
  },
  {
    ...
    author: "john doe",
    date: "02/05/2024",
    storyTitle: `Press Tv               26/11/2016
...
`,
  ...
  },
  {
    ...
    des1: "When I returned to Syria at 12, I rebelled against everyone—authority, the police, and especially the political system. I refused to be enrolled in the Shabiba (Ba'ath Youth), rejecting the indoctrination and slogans forced upon students. I never accepted to be just a number in this country, a cog in the system that dictated how we should think, act, and exist.",
    des2: "Since the age of fourteen, I had engaged my friends in Damascus in debates over the existence of God. Back then, no one dared question religion or the notion of a creator. They labelled me a heretic, believing that me disregard for social and political order was a direct result of my rejection of both God and authority.",

    des3: "At fifteen, my rebellion deepened. I made acquaintances with French employees at the French Cultural Center, where I found an intellectual and cultural connection that was absent among my own friends. At the same time, I traveled across Syria with friends my age, engaging in endless debates about God, religions, and the taboos that society tried to impose on us. Photo 10 Photo 11 Photo 12 Photo 13",
    des4: "Since adolescence, life was something to be consumed—every last drop, whether bitter or sweet. After my baccalaureate, I went to Germany to study, but I quickly realised that its structured, rigid, and highly organised society did not suit me. It felt too constrained, too predictable, too confining.",
    des5: `There, I met refugees who had fled war—Lebanese, Palestinians—and for the first time, I truly connected with the full scope of Palestinian suffering, beyond the fragments I had heard from my mother, who worked at UNRWA in Damascus, or the stories of resistance I had encountered at school. Photo 14 Photo 15 Photo 16 Photo 17`,
    des6: `I went to Paris, the city I had first fallen in love with at 10 years old, a place that had left an imprint on my mind. Paris had always felt like home—its intellectual vibrancy, its artistic defiance, its embrace of free thought resonated with the spirit of rebellion I carried within me.`,
  ...
  },
  {
    ...
    screens: pImg3,
    storyTitle: `Yet, with time, I found myself caught between two forces—one that compelled me to act, to create, to fight for change, and another that whispered the absurdity of it all. I was passionate about causes, about ideas, about possibilities, but I also saw the futility in human existence. I oscillated between engagement and nihilism, between building something new and accepting that nothing truly lasts. Death was not something I feared; rather, I saw it as an inevitable release, perhaps even a form of salvation. And maybe that's why I sought movement, why stability never suited me—I needed to chase moments of fascination before they lost their meaning. Photo 18 Photo 19 Photo 20`,
    des1: "I met an Israeli young woman, the same age as me, and we became very close. Her life was a tragedy in itself—a mother who had survived the Shoah, a father who refused to acknowledge her, and the wreckage of two failed love stories. Over time, life became increasingly unbearable for her, and depression consumed her until, one day, she chose to surrender herself to death.",
    des2: "The police advised me not to see her body, urging me to keep the memory of her as the beautiful woman I had known. But through her, I began to truly understand both miseries—Palestinian and Israeli. Photo 21 Photo 22 Photo 23 Photo 24",
    des3: "Never once did I feel a sense of satisfaction. I drifted from psychology to painting, passed through writing, and eventually found myself in politics—never settling, always searching, as if no path could contain me.",
    des4: "<strong>Painting-a style of life</strong>",

    des5: "At the beginning of 1994, I started painting. My brother, Jean—one of the greatest contemporary painters in my eyes—was my first inspiration. I was drawn to his creative style, captivated by the raw intensity of his work.",
    des6: "For me, painting was never just a craft; it was an act of defiance—a rebellion against imposed narratives and the rigid expectations of what a woman should be. My work was raw, unfiltered, unapologetic. From the very beginning, my art was a form of resistance, a means to challenge the world as I saw it, to reject the suffocating conventions that sought to dictate how a woman, a body, or an artist should be perceived.",
    des7: `The female form has always been central to my work, but not in the way it's been commodified for centuries. I refused to depicted it as a passive object of beauty or desire. To me, the body is a battlefield—a paradox, both a prison and a tool of liberation. My brushstrokes were never meant to comfort; they were meant to provoke, to unearth something unsettling, something that forces the viewer to confront their own gaze, their own biases.`,
    des8: `I never cared for perfect symmetry or predictable aesthetics. I paint to merge chaos with structure, to blend dream and reality until the line between them collapses. My canvases don't tell linear stories—they vibrate, they pulse with contradictions. Critics have said my work feels like music—that it carries its own rhythm. I like that idea. Because art, for me, has always been about breaking silence, shattering complacency.`,
    des9: `I've exhibited my work in different places, seen people stare, question, sometimes even recoil. And I embrace that. Art should be unsettling. It should gnaw at something inside you, push you to see beyond the surface.Photo 25 Photo 26 Photo 27 Photo 28 Photo 29`,
  ...
  },
  {
    ...
    screens: pImg3,
    storyTitle: `<strong>1997–2007: A Life of Art, Motherhood, and Fighting Spirit</strong>`,
    des1: "Between 1997 and 2007, I balanced motherhood, art, and self-discipline. I had separated from my daughter's father when she was almost two years old. Until she was 14, when the Syrian revolt began, my life was intertwined with hers.",
    des2: "I drove her to her activities, to see friends we traveled together, went out often, even with my own friends. I was never absent from her life. But at the same time, I pursued my own path, refusing to let motherhood define me entirely.Photo 30 Photo 31 Photo 32 Photo 33 Photo 34 Photo 35 Photo 36 Photo 37 Photo 38",
    des3: "Along side this, I trained in kickboxing and Muay Thai—not just for self-defence, but for self-control. The discipline I gained in combat extended beyond the ring, shaping how I approached life itself.Photo 39 Photo 40 Photo 41",
    des4: 'Seeking another artistic outlet, I enrolled at "Cours Florent," immersing myself in performance and storytelling. Theatre gave me a voice—a structured yet liberating way to channel my thoughts and emotions. It was through this experience that I later began writing for Al Hiwar Al Mutamadin. Photo 42 Photo 43 Photo 44 Photo 45',

    des5: "<strong>2007: The Turning Point—My Atheist and Political Activism</strong>",
    des6: "In 2007, I began writing to challenge religious and political dogmas in the Arab world. My knowledge of psychology and anthropology helped me dissect religions and cultures, which became the foundation of my first articles, writings, and TV program.",
    des7: `I wrote publicly, encouraged by my elder brother Nabil, who believed in me and in my ability to write. Perhaps I had inherited this gift from my father—the ability to dismantle the dogmas that governed so many aspects of life in the Arab world.`,
    des8: `At the time, platforms like Al Hiwar Al Mutamadin (Civil Discourse) were among the few spaces where secularists, atheists, and free thinkers could engage in meaningful discussions without censorship. Through these debates, I connected with like-minded individuals such as Kacem El Ghazzali, Waleed Al-Husseini, and many others who, like me, waged an intellectual rebellion against the constraints imposed by religion and tradition.`,
    des9: `My activism wasn't confined to words—it was action. I helped ex-Muslims escape persecution—providing financially and logistical support, and at times, offering them refuge when they had nowhere else to turn.Photo 46 Photo 47 Photo 48`,
  ...
  },
  {
    ...
    screens: pImg3,
    storyTitle: `<strong>Political Fight: A Struggle for Secularism and Inclusion</strong>`,
    des1: "Yet, entring politics forced me to reorganise my ideas—for I knew that most people needed some structures to order their lives. Thus emerged my quest to find a balance—one that respected individual freedom while ensuring enough structure to maintain order, without stripping away personal identity or crushing the human desire for self-fulfilment.",
    des2: "<i>The Arab Spring and My Exclusion from the Opposition</i>",
    des3: "In 2010, I played a key role in commentating and writing about the Tunisian revolution. As the Arab Spring gathered momentum, I felt compelled to return to Syrian political life. I co-founded, alongside other opponents, the secular democratic forces against Bashar al-Assad, which led to my position in the Syrian National Council (SNC).Photo 49 Photo 50 Photo 51",
    des4: "However, my outspoken warnings about the rise of Radical Islamists in Syria and Muslim fundamentalists within the opposition made me a target. By May 2012, I was expelled from the SNC, cast aside by the very movement I had helped build. Many within the Syrian opposition, including former allies, actively worked against me, seeking to silence my voice and remove me from political life. My unwavering secular stance had made me an outsider, but I refused to retreat.",

    des5: "<i>A New Political Vision: Building a Pluralistic Future</i>",
    des6: "During this turbulent period, my life took both a personal and political turn. I met my love, Fabien Baussart, who would later become my husband and a partner in political initiatives. Together, we launched multiple political projects to counter the forces that had excluded me.Photo 52 Photo 53 Photo 54 Photo 55 Photo 56 Photo 57 Photo 58 Photo 59 ",
    des7: `Determined to continue my fight for a secular, pluralistic Syria, I established the Movement for a Pluralistic Society with the help of Fabien after my exclusion from both the SNC and the secular democratic forces. This was my way of ensuring that the principles of secularism, democracy, and coexistence did not disappear amid the chaos of war and extremism.Photo 60 Photo 61 Photo 62 `,
    des8: `<i>The Astana Platform: A Path to Diplomacy</i>`,
    des9: `One of the key political initiatives I spearheaded was the Astana Platform, which I launched with Fabien in 2015 after requesting that the President of Kazakhstan establish a spaceto unite moderate Syrian opposition figures. Video 1`,
  ...
  },
  {
    ...
    screens: pImg3,
    storyTitle: `Once again, both allies and enemies conspired to exclude me from the Geneva negotiations in 2017. However, Fabien and I responded by launching a new initiative to establish a constitutional committee. This initiative was made possible with the support of former Italian Foreign Minister Giulio Terzi and former Turkish Foreign Minister Yaşar Yakış, along with the collaboration of Syrian and French constitutionalists. Video 2, Video 3`,
    des1: "On 13 January 2018, I, along with other members of the Astana Platform, participated in the Syrian National Congress as President of the Astana Platform. There, I emphasised the urgency of creating a constitutional committee to facilitate Syria's peace process. The proposal was later ",
    des2: "adopted by the UN and the Astana Troika (Russia, Iran, and Turkey), marking a significant step toward a political resolution.Photo 66 Photo 67",
    des3: "<i>Fighting for Secularism Against Political Exclusion</i>",
    des4: "My journey in Syrian politics has been marked by exclusion, betrayal, and constant battles—not just against the Assad regime, but also against factions within the opposition that sought to erase secular voices from the movement.",

    des5: "Yet, despite their attempts to silence me, I remained unwavering. I created new platforms, new alliances, and alternative pathways to keep the secular, democratic vision for Syria alive. My political fight was never about seeking a position or personal recognition—it was and remains a struggle to defend a Syria where secularism and pluralism are not erased by either authoritarianism or fundamentalism.",
    des6: "<i>Legacy of Resistance and Political Survival</i>",
    des7: `The political landscape remains treacherous, but survival is its own form of resistance. While many of my former allies turned against me, I continue to shape discussions, influence policy, and push forward alternatives to religious and authoritarian rule.`,
    des8: `Exclusion did not weaken me—it strengthened my resolve. In a war where voices are either bought, silenced, or erased, mine stands defiant.`,
    author: "randa-kassis",
    authorTitle: "politician",
    date: "25 Sep 2023",
    otherimg1: oimg19,
  ...
  },
  {
    ...
    screens: pImg3,
    storyTitle: `<strong>The Contradiction That Defines Me</strong>`,
    des1: "Since adolescence, I had embraced nihilism—living each day as it came, indifferent to the future. But the birth of my daughter stirred something imperceptible within me—an unseen force that subtly tempered my once unrestrained defiance.",
    des2: 'In those rare moments of stillness, I would catch my own reflection in her eyes and think, "What if I were to disappear all of a sudden?" It was an uninvited thought, yet one that recurred often enough to become part of me. After all, my daughter had no one but me.',
    des3: "My profound love and fierce attachment to her inevitably forced me to reconsider my anarchic tendencies—not to abandon them, but at least to rein in the chaos within. And yet, I still savoured the taste of disorder—the raw, untamed freedom that refused to be buried within me.",
    des4: "<strong>The Absurdity of Emotions and the Hierarchy of Beings</strong>",

    des5: "I recognise the absurdity of emotions—love, fear, joy, grief—but I also saw their fleeting intensity as the fabric of life's meaning, even if that meaning was illusory.",
    des6: "Humans, I thought, were burdened by their awareness of life's absurdity, suffering more profoundly than other creatures who simply existed in harmony with nature. This is why I saw animals as superior to humans—free fromexistential dread, they lived in harmony with nature.",
    des7: `My thoughts often wandered toward reordering the hierarchy of existence. I would elevate dogs to the pinnacle, seeing in them a purity and harmony with nature that humans had long forsaken. If I could, I would burn the gods and uproot the virus of religion from human minds.  If I had the power, I would sterilise humanity as I did my stray animals—not out of cruelty, but mercy. Like them, humans are trapped in a cycle of suffering they are too blind to break. In Greece, I spared strays the misery of endless reproduction; if only humans could be pared from their own self-inflicted torment.`,
    des8: `<strong>A Life Without Meaning, Yet Full of Contradiction</strong>`,
    des9: `Life, to me, was a poorly scripted tragedy—its characters stumbling through their lines, oblivious to the absence of direction, climax, or resolution. The scenes unfolded haphazardly, devoid of meaning, and the audience—humanity—was too preoccupied to question the chaos. I watched this performance with quiet indifference, as though seated in the front row of a tragicomic play. Humans, mere puppets, marched unthinking towards their fates, oblivious to the strings that bound them. <br><br> And yet, this absurdity brought me a peculiar kind of satisfaction.`,
    des10: `On one hand, I had no desire to reform the world, finding solace in my freedom to move untethered, unshackled by dogma or the rigidity of systems. On the other hand, I work tirelessly and passionately to make a difference—whether striving to improve the conditions for animals or seeking solutions for Syria. <br><br>This paradox defines me—a restless spirit, torn between accepting life's futility and a fierce determination to leave my mark on it.`,
    des11: `<strong>Moving Forward, Without Illusions</strong>`,
    des12:
  ...
  },
  {
    id: "22",
    title: "A rebel at heart: My Story",
    slug: "a-rebel-at-heart-my-story9",
    screens: pImg3,
    storyTitle: `<strong>A Life Without Meaning, Yet Full of Contradiction</strong>`,
    des1: "Life, to me, was a poorly scripted tragedy—its characters stumbling through their lines, oblivious to the absence of direction, climax, or resolution. The scenes unfolded haphazardly, devoid of meaning, and the audience—humanity—was too preoccupied to question the chaos. I watched this performance with quiet indifference, as though seated in the front row of a tragicomic play. Humans, mere puppets, marched unthinking towards their fates, oblivious to the strings that bound them.",
    des2: "On one hand, I had no desire to reform the world, finding solace in my freedom to move untethered, unshackled by dogma or the rigidity of systems. On the other hand, I work tirelessly and passionately to make a difference—whether striving to improve the conditions for animals or seeking solutions for Syria.",
    des3: "This paradox defines me—a restless spirit, torn between accepting life's futility and a fierce determination to leave my mark on it.",
    des4: "<strong>Moving Forward, Without Illusions</strong>",

    des5: "Today, I continue to live in that contradiction. I advocate for change while questioning its worth. I embrace the temporary, knowing that permanence is an illusion. I do not believe in an ideal world, nor do I seek one. Instead, I move forward, navigating the currents of life much like I always have—without illusions, without submission, and without regret.",
    author: "randa-kassis",
    authorTitle: "politician",
    date: "25 Sep 2023",
    otherimg1: oimg28,
