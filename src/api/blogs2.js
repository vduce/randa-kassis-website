...
I cannot even ask for your forgiveness, for you have departed this life, and there is no life for you beyond it. How, then, can I console myself, when I have spent years burdened by the bitterness of self-reproach since my father's passing? I left just days before his death and never stayed. Was I fleeing from grief, from finality? Or was I simply placing myself above all else? I do not know…`,
    ...
    des10: `My only solace is knowing that you are free from pain. And so, I write not to seek redemption, nor to be absolved of what I cannot change, but simply because silence is unbearable.`,
    author: "randa-kassis",
    authorTitle: "politician",
    date: "25 Sep 2023",
    otherimg1: oimg1,
...
Kassis underscored that President Vladimir Putin's initiative to hold the Syrian National Dialogue Congress in Sochi is an important step, which, unfortunately, was not accepted by some political figures.`,
    ...
    des8: `
The politician emphasised that she had made efforts to gather as many representatives of the Syrian opposition as possible to form a working group. “We need to start finding the way out of the crisis immediately. I believe that it is impossible without the creation of a new constitution,” she noted.`,
    des9: `
Speaking to Sputnik, Kassis shed light on the Astana platform’s plans and program. The politician emphasised the necessity to create a “constitutional commission” within the framework of the negotiations.`,
    des10: `
...
`,
  ...
  },
  {
    ...
    screens: pImg3,
    description: `<strong>I was not born a rebel, but rebellion found me early.</strong>`,
    des2: `As a child, I was inquisitive—curious about the world, about my body, about the invisible rules that dictated how I should exist within it. I remember being five or six years old, exploring myself with innocent curiosity, only to discover something I had been conditioned to believe was impure. My instinct was to cleanse, to rid myself of what I thought was dirt. But that act, simple and instinctive, was also my first conscious rejection of an imposed taboo.`,
    des3: "Later, as an adolescent, I repeated the act—not out of naivety, but with full intention. I had no desire for my hymen to be lost through sexual intercourse, for it to be a symbol of virtue or a transaction. I despised its very concept.",
    des4: "Even before I understood rebellion in an intellectual sense, I had already lived it. Algeria shaped me in ways I could never have anticipated. There, that I grasped the nature of power—how it operates, how it can be resisted. I had moved from a relatively sheltered world into an environment where survival meant more than just existing; it required assertion, defiance, a willingness to stand one’s ground. I was not born a fighter, but Algeria made me one. Photo 4 Photo 5 Photo 6",
    des5: "<strong>The First Battle: Defying Power</strong>",
    des6: "My first physical confrontation was a defining moment. It happened in the schoolyard, a place that, for many children, is merely a setting for games and lessons, but for me, it became an early battlefield. A group of boys, emboldened by their own sense of entitlement, sought to intimidate me. I refused to shrink. When one of them made his move, I retaliated. I knocked him to the ground, but that act of defiance came at a price. The boys turned on me, pelting me with stones.",
    des7: "The pain was real, but it wasn’t what left a mark on me. What I remember most vividly isn’t the pain—it’s the realisation that fear is a weapon. And I could choose not to carry it. I stood there, battered but unbroken, and something shifted within me. I knew that mere defence was not enough. I had to go on the offensive.",
...
`,
  ...
  },
  {
    ...
    des3: "I drove her to her activities, to see friends we traveled together, went out often, even with my own friends. I was never absent from her life. But at the same time, I pursued my own path, refusing to let motherhood define me entirely.Photo 30 Photo 31 Photo 32 Photo 33 Photo 34 Photo 35 Photo 36 Photo 37 Photo 38",
    des4: "Along side this, I trained in kickboxing and Muay Thai—not just for self-defence, but for self-control. The discipline I gained in combat extended beyond the ring, shaping how I approached life itself.Photo 39 Photo 40 Photo 41",
  ...
  },
  {
    ...
    des2: "Yet, entring politics forced me to reorganise my ideas—for I knew that most people needed some structures to order their lives. Thus emerged my quest to find a balance—one that respected individual freedom while ensuring enough structure to maintain order, without stripping away personal identity or crushing the human desire for self-fulfilment.",
    des3: "<i>The Arab Spring and My Exclusion from the Opposition</i>",
    ...
    des6: "<i>A New Political Vision: Building a Pluralistic Future</i>",
    des7: "During this turbulent period, my life took both a personal and political turn. I met my love, Fabien Baussart, who would later become my husband and a partner in political initiatives. Together, we launched multiple political projects to counter the forces that had excluded me.Photo 52 Photo 53 Photo 54 Photo 55 Photo 56 Photo 57 Photo 58 Photo 59 ",
    des8: `Determined to continue my fight for a secular, pluralistic Syria, I established the Movement for a Pluralistic Society with the help of Fabien after my exclusion from both the SNC and the secular democratic forces. This was my way of ensuring that the principles of secularism, democracy, and coexistence did not disappear amid the chaos of war and extremism.Photo 60 Photo 61 Photo 62 `,
    des9: `<i>The Astana Platform: A Path to Diplomacy</i>`,
    des10: `One of the key political initiatives I spearheaded was the Astana Platform, which I launched with Fabien in 2015 after requesting that the President of Kazakhstan establish a spaceto unite moderate Syrian opposition figures. Video 1`,
    des11: `I participated in the 2016 Geneva Peace Talks as part of the Moscow/Astana groups, serving as Co-President alongside Qadri Jamil in the Syrian secular and democratic opposition delegation.Photo 63 Photo 64 Photo 65`,
    author: "randa-kassis",
    authorTitle: "politician",
    date: "25 Sep 2023",
    otherimg1: oimg16,
  ...
  },
  {
    ...
    des2: "On 13 January 2018, I, along with other members of the Astana Platform, participated in the Syrian National Congress as President of the Astana Platform. There, I emphasised the urgency of creating a constitutional committee to facilitate Syria’s peace process. The proposal was later ",
    ...
    des4: "<i>Fighting for Secularism Against Political Exclusion</i>",
    ...
    des7: "<i>Legacy of Resistance and Political Survival</i>",
    ...
    des9: `Exclusion did not weaken me—it strengthened my resolve. In a war where voices are either bought, silenced, or erased, mine stands defiant.`,
    author: "randa-kassis",
    authorTitle: "politician",
    date: "25 Sep 2023",
    otherimg1: oimg19,
  ...
  },
  {
    ...
    des2: "Since adolescence, I had embraced nihilism—living each day as it came, indifferent to the future. But the birth of my daughter stirred something imperceptible within me—an unseen force that subtly tempered my once unrestrained defiance.",
    ...
    des9: `<strong>A Life Without Meaning, Yet Full of Contradiction</strong>`,
    des10: `Life, to me, was a poorly scripted tragedy—its characters stumbling through their lines, oblivious to the absence of direction, climax, or resolution. The scenes unfolded haphazardly, devoid of meaning, and the audience—humanity—was too preoccupied to question the chaos. I watched this performance with quiet indifference, as though seated in the front row of a tragicomic play. Humans, mere puppets, marched unthinking towards their fates, oblivious to the strings that bound them. And yet, this absurdity brought me a peculiar kind of satisfaction.`,
    des11: `On one hand, I had no desire to reform the world, finding solace in my freedom to move untethered, unshackled by dogma or the rigidity of systems. On the other hand, I work tirelessly and passionately to make a difference—whether striving to improve the conditions for animals or seeking solutions for Syria.`,
    des12: `This paradox defines me—a restless spirit, torn between accepting life’s futility and a fierce determination to leave my mark on it.`,
    des13: `<strong>Moving Forward, Without Illusions</strong>`,
    des14:
