                    ...
                    <div className="row">
                        <div className="col col-lg-3 col-md-6 col-12 col-md-6 col-sm-12 col-12">
                            <div className="widget about-widget">
                                ...
                                <div className="social">
                                    <ul>
                                        <li>
                                            <a href="https://www.facebook.com/randakassis.co" target="_blank" rel="noopener noreferrer">
                                                <i className="fi flaticon-facebook-app-symbol"></i>
                                            </a>

                                        </li>
                                        <li>
                                            <a href="https://www.youtube.com/user/helene237" target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="col col-lg-3 col-md-6 col-12 col-md-6 col-sm-12 col-12">
                            <div className="widget link-widget s2">
                                ...
                                <ul>
                                    <li><Link onClick={ClickHandler} to="/media">News</Link></li>
                                    <li><Link onClick={ClickHandler} to="/media">Interviews</Link></li>
                                    <li><Link onClick={ClickHandler} to="/media">Program Tv</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col col-lg-3 col-md-6 col-12 col-md-6 col-sm-12 col-12">
                    ...
                    <div className="row align-items-center">
                        <div className="d-flex justify-content-center">
                            <ul className="list-unstyled text-center">
                                <li>
                                    &copy; 2025 <Link onClick={ClickHandler} to="/">randa kassis</Link>. All rights reserved.
                                </li>
                            </ul>
                        </div>
                    </div>
