                            ...
                            <div className="col col-lg-4 col-md-6 col-12" key={bl}>
                                <div className="wpo-blog-item">
                                    ...
                                    <div className="wpo-blog-content">
                                        <ul>
                                            <li><a href="blog-single.html">{blog.date}</a></li>
                                            <li>by: <Link onClick={ClickHandler} to={`/blog-single/${blog.slug}`}>{blog.author}</Link></li>
                                        </ul>
                                        <h2><Link onClick={ClickHandler} to={`/blog-single/${blog.slug}`}>{blog.title.slice(0,32)}</Link></h2>
                                        <span>{blog.description.slice(0,100)}</span>... &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
