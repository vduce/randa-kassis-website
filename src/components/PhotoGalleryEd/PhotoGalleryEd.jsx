      ...
      return (
        <div className="gallery-ed-grid">
          {photos.slice(0, 2).map((photo, index) => (
            <div key={index} className="gallery-ed-item" onClick={() => openGallery(index)}>
              <img
                src={photo.src}
      ...
      return (
        <div className="gallery-ed-grid-three-photos">
          ...
          <div className="gallery-ed-bottom-row">
            <div className="gallery-ed-item" onClick={() => openGallery(2)}>
              <img
                src={photos[2].src}
      ...
      <div className="gallery-ed-grid-five-plus-photos">
        ...
        <div className="gallery-ed-bottom-row">
          {photos.slice(3, 5).map((photo, index) => (
            <div key={index + 3} className="gallery-ed-item" onClick={() => openGallery(index + 3)}>
              <img
                src={photo.src}
